...
CREATE TABLE `Possiede` (
  ...
  KEY `id_equipaggiamento` (`id_equipaggiamento`),
  CONSTRAINT `Possiede_ibfk_1` FOREIGN KEY (`id_bici`) REFERENCES `Bicicletta` (`id_bici`),
  CONSTRAINT `Possiede_ibfk_2` FOREIGN KEY (`id_equipaggiamento`) REFERENCES `Equipaggiamento` (`id_equipaggiamento`)
...
INSERT INTO `Possiede` VALUES (1,1),(4,2),(2,3),(4,3),(2,4),(4,4),(7,4),(8,4),(7,5),(8,5),(2,6);
